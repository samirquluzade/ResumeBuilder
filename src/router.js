    ...
    return(
        <Page>
          <Routes>
              ...
              <Route exact path="/skills" element={[<Skills handleChangeSkill={handleChangeSkill} handleChangeSkillLevel={handleChangeSkillLevel} data={skills} addSkill={addSkill} />,<CV data={data} education={education} skills={skills} />]} />
          </Routes>
        </Page>
    );
}
